...
TASK_ITEM(mcu_rcv_thread,       mcu_task_id,   5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
...
#endif
TASK_ITEM(ServerThreadEntry,      server_task_id,   10*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
