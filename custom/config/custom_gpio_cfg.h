...
GPIO_ITEM(PINNAME_DTR,            PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_DISABLE)
GPIO_ITEM(PINNAME_RI,             PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_DISABLE)
GPIO_ITEM(PINNAME_DCD,            PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_DISABLE)
GPIO_ITEM(PINNAME_CTS,            PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_DISABLE)
