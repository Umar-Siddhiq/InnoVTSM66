...
#warning "AUTO PROFILE SWITCH is disabled, device will be always in airtel profile, switch operator manually if needed"
#endif

//#define ENABLE_PROFILE_BLACKLIST
...
#define EXTENDED_IPS
	...
	#define DEFAULT_IP1   "78.46.190.117/vlt"
	#define DEFAULT_PORT1 "50024"
	// NO Support for IP2!
	#define TEST_SERVER
	#ifdef TEST_SERVER
	#define 	DEFAULT_IP3  	"124.123.18.16"
	#define		DEFAULT_PORT3	"50001" 	
	#else
	...
	#define 	DEFAULT_IP1  	"103.195.217.191"
	#define		DEFAULT_PORT1	"9201"
	#define 	DEFAULT_IP2  	"103.195.217.191"
	...
	#define 	DEFAULT_INV_STB		60
	#define 	DEFAULT_INV_STM		120
    //#define 	DEFAULT_INV_STM		2100 // 35 mins
...
//#define VIRTUAL_IMEI
#define VIMEI  "868329088626522"

//#define VIRTUAL_IMSI
#define VIMSI  "404844263384794"

//#define VIRTUAL_SIMCCID
#define VCID   "8991840042633847940F"
...
typedef enum {TAISYS=0, SENSORISE, GnD, COLORPLAST}SIMMakeTypedef;
...
typedef struct 
{
	...
	uint8_t ProfileFailCount[5];  // Tracks consecutive failures per profile (index 1-4)
	uint8_t IsPrevMain;
}VTSStateTypedef;
